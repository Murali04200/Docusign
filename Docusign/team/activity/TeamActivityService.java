...
public class TeamActivityService {
    ...
    public void recordMembershipChange(Long teamId,
        ...
        if (actor != null) {
            ...
            // DO NOT record email to protect personal account privacy
            // activity.setActorEmail(actor.getEmail()); // REMOVED: Privacy protection
        }
    ...
    public void recordGeneric(Long teamId,
        ...
        // DO NOT record email to protect personal account privacy
        // activity.setActorEmail(actorEmail); // REMOVED: Privacy protection
